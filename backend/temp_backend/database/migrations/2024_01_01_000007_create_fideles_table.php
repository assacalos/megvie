...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('fideles', function (Blueprint $table) {
            ...
            $table->string('appartient_famille')->nullable();
            ...
            $table->foreignId('parrain_id')->nullable()->constrained()->nullOnDelete();
            $table->foreignId('pasteur_id')->nullable()->constrained()->nullOnDelete();
            $table->foreignId('chef_disc_id')->nullable()->constrained('chef_discs')->nullOnDelete();
            $table->foreignId('famille_id')->nullable()->constrained()->nullOnDelete();
            $table->string('formation')->nullable();
            $table->integer('annee_experience')->nullable();
            $table->foreignId('corps_metier_id')->nullable()->constrained('corps_metiers')->nullOnDelete();
            $table->timestamps();
        });
    }
